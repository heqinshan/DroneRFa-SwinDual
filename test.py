...
def main():
    ...
    parser.add_argument('--model', type=str, required=True, choices=['swin_dual', 'resnet50', 'resnet18', 'alexnet','vgg16'])
    ...
    test_dataset = DroneRFaDataset(config.DATA_ROOT, transform, config.SEGMENT_LENGTH, 10, split='test', train_ratio=0.7, val_ratio=0.15, return_path=args.gradcam)
